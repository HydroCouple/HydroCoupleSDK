...
TimeTINMultiInputDouble::TimeTINMultiInputDouble(const QString &id,
  ...
  :AbstractMultiInput(id, QList<Dimension*>({timeDimension, cellDimension, edgeDimension, nodeDimension}),
...
TimeTINMultiInputDouble::~TimeTINMultiInputDouble()
{

}

HydroCouple::Spatial::MeshDataType TimeTINMultiInputDouble::meshDataType() const
{
  return m_dataType;
}

HydroCouple::Spatial::IPolyhedralSurface *TimeTINMultiInputDouble::polyhedralSurface() const
{
  return m_TINSurface.data();
}

QList<IDateTime*> TimeTINMultiInputDouble::times() const
{
...
IDateTime *TimeTINMultiInputDouble::time(int timeIndex) const
{
  return m_times[timeIndex];
}

int TimeTINMultiInputDouble::timeCount() const
{
  return m_times.size();
}

bool TimeTINMultiInputDouble::addTime(SDKTemporal::DateTime *time)
{
...
bool TimeTINMultiInputDouble::removeTime(SDKTemporal::DateTime *time)
{
...
void TimeTINMultiInputDouble::resetTimeSpan()
{
  if(m_times.size())
  {
...
ITimeSpan *TimeTINMultiInputDouble::timeSpan() const
{
  return m_timeSpan;
}

HydroCouple::IDimension *TimeTINMultiInputDouble::timeDimension() const
{
  return m_timeDimension;
}

HydroCouple::IDimension *TimeTINMultiInputDouble::cellDimension() const
{
  return m_cellDimension;
}

HydroCouple::IDimension *TimeTINMultiInputDouble::edgeDimension() const
{
  return m_edgeDimension;
}

HydroCouple::IDimension *TimeTINMultiInputDouble::nodeDimension() const
{
  return m_nodeDimension;
}

HydroCouple::Spatial::ITIN *TimeTINMultiInputDouble::TIN() const
{
  return m_TINSurface.data();
}

int TimeTINMultiInputDouble::dimensionLength(const std::vector<int> &dimensionIndexes) const
{
...
void TimeTINMultiInputDouble::getValue(const std::vector<int> &dimensionIndexes, void *data) const
{
...
void TimeTINMultiInputDouble::getValue(int timeIndex, int cellDimensionIndex,
...
void TimeTINMultiInputDouble::setValue(const std::vector<int> &dimensionIndexes, const void *data)
{
  double* dataC = (double*) data;
...
void TimeTINMultiInputDouble::setValue(int timeIndex, int cellDimensionIndex, int edgeDimensionIndex, int nodeDimensionIndex, const void *data)
{
  double* dataC = (double*) data;
...
bool TimeTINMultiInputDouble::moveData(int fromTimeIndex, int toTimeIndex)
{
...
void TimeTINMultiInputDouble::moveDataToPrevTime()
{
  if(m_times.size() > 1)
  {
