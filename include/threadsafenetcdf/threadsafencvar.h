#ifndef THREADSAFENCVAR_H
#define THREADSAFENCVAR_H
...
class ThreadSafeNcVarAtt;
class ThreadSafeNcDim;

class HYDROCOUPLESDK_EXPORT ThreadSafeNcVar
{
 ...
 public:
    ...
    */
    ThreadSafeNcVar (const ThreadSafeNcGroup& grp, const int& varId);

    /*! assignment operator  */
    ThreadSafeNcVar& operator =(const ThreadSafeNcVar& rhs);

    /*! equivalence operator */
    bool operator==(const ThreadSafeNcVar& rhs) const;

    /*!  != operator */
    bool operator!=(const ThreadSafeNcVar& rhs) const;

    /*! The copy constructor. */
    ThreadSafeNcVar(const ThreadSafeNcVar& ncVar);

    ThreadSafeNcVar(const netCDF::NcVar& ncVar);
    ...
    /*! comparator operator  */
    friend bool operator<(const ThreadSafeNcVar& lhs,const ThreadSafeNcVar& rhs);
    ...
    ThreadSafeNcDim getDim(int i) const;

    /*! Gets the set of NcDim objects. */
    std::vector<ThreadSafeNcDim> getDims() const;
    ...
    ThreadSafeNcVarAtt getAtt(const std::string& name) const;

    /*! Gets the set of attributes. */
    std::map<std::string,ThreadSafeNcVarAtt> getAtts() const;
    ...
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, size_t len, const char** dataValues) const ;

    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const std::string& dataValues) const ;

    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const unsigned char* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const signed char* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, short datumValue) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, int datumValue) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, long datumValue) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, float datumValue) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, double datumValue) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, unsigned short datumValue) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, unsigned int datumValue) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, unsigned long long datumValue) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, long long datumValue) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const short* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const int* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const long* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const float* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const double* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const unsigned short* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const unsigned int* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const unsigned long long* dataValues) const ;
    /*! \overload
     */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const long long* dataValues) const ;
    /*!
    ...
    */
    ThreadSafeNcVarAtt putAtt(const std::string& name, const netCDF::NcType& type, size_t len, const void* dataValues) const ;
    ...
    */
    void setChunking(netCDF::NcVar::ChunkMode chunkMode, std::vector<size_t>& chunksizes) const;
    ...
    */
    void getChunkingParameters(netCDF::NcVar::ChunkMode& chunkMode, std::vector<size_t>& chunkSizes) const;
    ...
    */
    void setEndianness(netCDF::NcVar::EndianMode endianMode) const;
    ...
    */
    netCDF::NcVar::EndianMode getEndianness() const;
    ...
    */
    void setChecksum(netCDF::NcVar::ChecksumMode checksumMode) const;
    ...
    */
    netCDF::NcVar::ChecksumMode getChecksum() const;
