...
#ifndef TIMEGEOMETRYOUTPUT_H
#define TIMEGEOMETRYOUTPUT_H


#include "core/abstractoutput.h"
#include "spatiotemporal/timegeometrycomponentdataitem.h"

class HYDROCOUPLESDK_EXPORT TimeGeometryOutputDouble : public AbstractOutput,
    ...
    public virtual HydroCouple::SpatioTemporal::ITimeGeometryComponentDataItem
{
  ...
  public:
    ...
    TimeGeometryOutputDouble(const QString &id,
    ...
    virtual ~TimeGeometryOutputDouble() override;
